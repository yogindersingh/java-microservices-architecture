...
public class GlobalExceptionsHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ErrorResponseDto> handleLoanNotFoundException(WebRequest request,
  ...
  public ResponseEntity<ErrorResponseDto> handleLoanException(WebRequest request, Exception exception) {
